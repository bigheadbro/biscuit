...
public class GenerateMyBatisMapperUtil {
	...
	public void init() {
		...
		try {
			connection = java.sql.DriverManager
					.getConnection(
							"jdbc:mysql://127.0.0.1:3306/biscuit?useUnicode=true&characterEncoding=utf-8",
							"root", "");
	...
	public static void main(String[] args) throws SQLException {
		...
		for(String table:args)
		{
			...
			// 模板文件所在的路径
			String path = "src/main/java/com/biscuit/util";
			// 设置参数
			...
			try {
				...
				// 输出
			    //Writer sw = new PrintWriter(new FileOutputStream(new File("src/main/resources/mapper/biscuit/entity/"+entity.getEntityName()+".java")));
